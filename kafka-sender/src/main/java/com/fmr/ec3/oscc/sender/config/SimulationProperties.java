...
public class SimulationProperties {
    ...
    public int getLoginPercent() { return loginPercent; }
    public void setLoginPercent(int loginPercent) { this.loginPercent = loginPercent; }
    ...
    public int getSipServerCount() { return sipServerCount; }
    public void setSipServerCount(int sipServerCount) { this.sipServerCount = sipServerCount; }
    public int getMediaServerCount() { return mediaServerCount; }
    public void setMediaServerCount(int mediaServerCount) { this.mediaServerCount = mediaServerCount; }
}
